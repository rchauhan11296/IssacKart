...
<form id="formID" method="get" action="">
        ...
        <tr height="40px">
        <td width="200px" align="center"> Branch Name :
        	</td>
 ...
 <%
		...
		if(id!=null){
			 DConnection db = new DConnection();
	 		 ResultSet rs1=null;
	 		 String qry = "select * from branch_detail where b_name LIKE '"+id+"%'";
	 		 rs1 = db.getData(qry);
	         String pc="",pn="",pcom="";
			...
			<tr align='center' bgcolor="#CCCCCC">
                 <form id="formID" method='post' action='updateuserData.jsp?bcode=<%=pc %>'>
		<td><% out.println(pc); %></td>
		<td><input type="text" class="validate[required,custom[noSpecialCaracters],length[0,20],ajax[ajaxUser]]"  size="11" value="<%=pn%>" name="bname" id="bname" ></td>
        <td><input type="text" class="validate[required,custom[noSpecialCaracters],length[0,20],ajax[ajaxUser]]" size="11" value="<%=pcom%>" name="badd" id="badd"></td>
