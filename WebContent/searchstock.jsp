...
<form id="formID" method="get" action="">
 <table width="560px" border="0" bgcolor="#9999FF" align="center" >
        ...
        <select name="type">
            ...
            <td width="152"><input type="text" name="pname" id="pname" /></td>
			...
			if(value!=null){
				...
				String qry1 = "SELECT b.i_code,i.i_name,i.i_company,b.i_quantity from branch_item b,item_detail i where b.i_code=i.i_code and b.b_code='"+br+"' and i."+type+" LIKE '"+value+"%'";
				 ...
				 String pc="",pn="",pcom="";
				  ...
				  out.println("<table border='0'  align='center' width='590px'><tr align='center' bgcolor='#CC99FF' height='50px'><td><b>ID</b></td><td><b>Name</b></td><td><b>Company</b><td><b>Quantity</b></td></tr>");
